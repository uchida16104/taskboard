...
* opened when you select "approved", and please go to https://github.com/users/name/projects/${projectsNumber}/views/${viewsNumber}.<br />
***${projectsNumber} and ${viewsNumber} are set optional.***

5. Going https://github.com/users/name/projects/${projectsNumber}/views/${viewsNumber}, please create the following columns.  <br />***(Please set this for the first time.)***
...
6. Please move task tickets according to their progress status.
